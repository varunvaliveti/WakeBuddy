...
public class MovementAlarmActivity extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        TextView alarmLabel = findViewById(R.id.movementAlarmText);
        alarmLabel.setText(label);

        Button stopAlarmButton = findViewById(R.id.stopAlarmButtonMovement);
